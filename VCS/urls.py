...
urlpatterns = [
    ...
    # Notifications Path --> Staff
    path('Hod/Staff/Send_Notification', HodViews.Staff_Send_Noti, name='Staff_Send_Noti'),
    path('Hod/Staff/Save_Notification', HodViews.Staff_Save_Noti, name='Staff_Save_Noti'),
    # Notifications Path --> Student
    path('Hod/Student/Send_Notification', HodViews.Student_Send_Noti, name='Student_Send_Noti'),
    path('Hod/Student/Save_Notification', HodViews.Student_Save_Noti, name='Student_Save_Noti'),
    ...
    # Notification path
    path('Staff/Notification', StaffViews.staff_Notification, name='staff_Notification'),
    path('Staff/mark_as_read/<str:status>', StaffViews.mark_as_read, name='mark_as_read'),
    ...
    # Notification path
    path('Student/Stud_Notification', StudentViews.Stud_Notification, name='Student_Notification'),
    path('Student/Std_mark_as_read/<str:status>', StudentViews.mark_as_read, name='s_mark_as_read'),
